...
fzflua.setup {
  ...
  grep              = {
    ...
    rg_opts        = "--column --hidden --line-number --no-heading --color=always --smart-case --max-columns=512 --glob=!vendor/* --glob=!shell_history/* --glob=!.git/*",
...
-- sets vim.ui.select to use fzf-lua plugin
